  ...
  <div
    className={`px-3 py-2 rounded-lg border transition-all duration-200 cursor-pointer ${
      selected
        ...
        : 'border-blue-700/40 bg-[#111]/95 hover:border-blue-500/60 hover:bg-blue-950/30 hover:shadow-md'
    }`}
  ...
  <div
    className={`px-3 py-2 rounded-lg border transition-all duration-200 cursor-pointer ${
      selected
        ...
        : 'border-purple-700/40 bg-[#111]/95 hover:border-purple-500/60 hover:bg-purple-950/30 hover:shadow-md'
    }`}
  ...
  <div
    className={`px-2.5 py-1.5 rounded-md border transition-all duration-200 cursor-pointer ${
      selected
        ...
        : 'border-green-700/40 bg-[#111]/95 hover:border-green-500/60 hover:bg-green-950/30 hover:shadow-md'
    }`}
...
const DefaultNode: React.FC<NodeProps<ReactFlowNodeData>> = ({ data, selected }) => (
  <div
    className={`px-2.5 py-1.5 rounded border transition-all duration-200 cursor-pointer ${
      selected
        ? 'border-gray-400 bg-[#282828] shadow-md ring-2 ring-gray-400/30'
        : 'border-gray-600/40 bg-[#111]/95 hover:border-gray-500/60 hover:shadow-md'
    }`}
  >
